...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
            ...
            KC_LCTL, LT(1,KC_Y), KC_X, KC_C, KC_V, KC_SLSH, KC_LGUI,  MO(2), KC_J, KC_M, KC_COMM, KC_DOT, LT(1,KC_MINS), KC_PGDN,
    ...
    [1] = LAYOUT(
            ...
            KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,              KC_NO, KC_NO, US_MICR, KC_SCLN, KC_COLN, KC_NO, US_ADIA,
    ...
    [2] = LAYOUT(
            ...
            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,        KC_TRNS, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_MSTP, KC_MPLY,
