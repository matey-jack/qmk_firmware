...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
            ...
            KC_NO, KC_TRNS, KC_NO, KC_NO, KC_PGUP, KC_PGDN, KC_NO, KC_NO, KC_NO, US_MICR, KC_SCLN, KC_COLN, KC_NO, US_ADIA,
    ...
    [2] = LAYOUT(
            ...
            KC_NO, KC_MPRV, KC_MNXT, KC_NO, KC_NO, KC_NO,           KC_NO, RM_NEXT, RM_HUEU, RM_SATU, RM_VALU, KC_NO,
            KC_NO, KC_MSTP, KC_MPLY, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, KC_NO,
