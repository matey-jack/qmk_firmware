...
// Switch to Hold mode before tapping term, when other key is pressed _and_ released, all before the tap/hold key is released.
...
// disable all effects except solid color, because apparently one effect is needed so it the OOTB code doesn't misbehave.
